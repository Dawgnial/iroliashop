    ...
    <footer className="bg-persian-blue text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-xl font-bold mb-4 font-vazir">خبرنامه</h3>
            <p className="text-white/80 mb-4 font-vazir leading-relaxed">
              برای اطلاع از آخرین محصولات، تخفیف‌ها و اخبار ایرولیا شاپ در خبرنامه ما عضو شوید.
            </p>
            <div className="flex">
              <Input type="email" placeholder="ایمیل خود را وارد کنید" className="w-full rounded-l-none rounded-r-md border-0 focus-visible:ring-1 focus-visible:ring-persian-gold font-vazir" />
              <Button className="bg-persian-gold hover:bg-opacity-90 text-persian-blue rounded-r-none rounded-l-md font-vazir">عضویت</Button>
            </div>
          </div>
        </div>
